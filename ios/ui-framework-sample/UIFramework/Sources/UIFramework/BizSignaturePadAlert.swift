...
/**
 * BizSignaturePadAlert - SwiftUI component matching Web UI-Framework `PPSignaturePadAlert.vue`.
 */
public struct BizSignaturePadAlert: View {
...
/**
 * Web UI-Framework parity alias for [BizSignaturePadAlert].
 */
public typealias PPSignaturePadAlert = BizSignaturePadAlert
