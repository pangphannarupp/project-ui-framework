...
/**
 * BizKhmerCalendarIsland - SwiftUI component matching Web UI-Framework `PPKhmerCalendarIsland.vue`.
 */
public struct BizKhmerCalendarIsland: View {
...
/**
 * Web UI-Framework parity alias for [BizKhmerCalendarIsland].
 */
public typealias PPKhmerCalendarIsland = BizKhmerCalendarIsland
