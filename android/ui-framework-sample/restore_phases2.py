...
# 1. Get original MainActivity.kt from git (path relative to repo root)
...
if not vf_p5s1 or not vf_p6c1 or not vf_p6l2:
    print("FAILED TO EXTRACT ONE OR MORE BLOCKS")
    exit(1)
...
if vf_p6c1:
    ...
    vf_p6c1 = vf_p6c1.replace('onActionClick =', 'onAction =')
    vf_p6c1 = vf_p6c1.replace('isHidden =', 'hidden =')
