...
watch(() => props.modelValue, (val) => {
  isOpen.value = val;
  if (val && (window as any).BMCManager) {
    const sheetData = {
        sheetTitle: "Confirm your purchase",
        packName: "Met5G 1",
        packDetails: "20GB + 100Mins + 100SMS",
        packPrice: "$ 1.50 / 7 days",
        description: "You are buying a Met5G 1:\n• Internet data\n• On-net calls\n• Validity: 7 days"
    };
    
    // Call the native Android function
    (window as any).BMCManager.showPurchaseBottomSheet(JSON.stringify(sheetData));
  }
});
watch(isOpen, (val) => {
