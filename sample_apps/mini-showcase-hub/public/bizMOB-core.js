...
bizMOBCore.System.alert = function() {

    var action = "callAlert";
    var callback = bizMOBCore.CallbackManager.save(arguments[0]._fCallback);

    var tr = {
        id:"ALERT_PLUGIN",
        param:{
            title:arguments[0]._sMessage,
            callback : callback
        }
    };
...
bizMOBCore.Network.requestTr = function(arg) {
    var timeout = arg._nReadTimeout != null && arg._nReadTimeout != undefined ? arg._nReadTimeout : 8;
    var message = {
...
bizMOBCore.EventManager.list = ["ready","resume","backbutton","open","close","networkstatechange", "appshortcut", "phonecalltracking", "gpstracking"];
...
bizMOBCore.EventManager.responser = function(oRequired, oOptions) {
    ...
    // alert(JSON.stringify(oRequired));
    // alert(JSON.stringify(oOptions));
