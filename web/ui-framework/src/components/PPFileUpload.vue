...
const emit = defineEmits<{
  ...
  (e: 'preview', file: PPFileItem): void;
}>();
...
.upload-dropzone.is-dragover {
  border-color: var(--pp-primary-light, #3880ff);
  background-color: #f0f4ff;
}
...
.file-progress-bar {
  height: 100%;
  background-color: var(--pp-primary-light, #3880ff);
  border-radius: 2px;
