<template>
  <div class="biz-ribbon-container">
    <!-- Ribbon Headers -->
    <div class="biz-ribbon-header">
      <div 
        v-for="tab in tabs" 
        :key="tab.id"
        :class="[
          'biz-ribbon-tab-header',
          { 'biz-ribbon-tab-header--active': activeTabId === tab.id },
          { 'biz-ribbon-tab-header--special': tab.color === 'primary' }
        ]"
    ...
    <!-- Ribbon Body (Slots for BizRibbonTab) -->
    <div class="biz-ribbon-body">
      <slot></slot>
    </div>
  </div>
</template>
...
.biz-ribbon-tab-header:hover {
  background-color: #e5e7eb;
}

.biz-ribbon-tab-header--active {
