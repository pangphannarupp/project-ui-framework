...
.biz-navigation-rail {
  ...
  background-color: var(--biz-rail-bg, #f3f4f9); /* M3 Surface container */
...
.rail-menu-toggle {
  ...
  cursor: pointer;
  margin-bottom: 8px;
  color: var(--biz-rail-item-color, #44474f);
...
.rail-item {
  ...
  min-height: 56px;
  cursor: pointer;
  color: var(--biz-rail-item-color, #44474f); /* M3 On-surface variant */
...
.rail-item.is-active .rail-item-icon-container {
  background-color: var(--biz-rail-active-bg, #d8e2ff); /* Secondary container */
  color: var(--biz-rail-active-color, #001a41); /* On-secondary container */
}
...
.rail-item.is-active {
  color: var(--biz-rail-active-label, #1a1b21); /* On-surface */
}
...
.rail-item-badge {
  ...
  top: -4px;
  right: 4px;
  background-color: var(--biz-rail-badge-bg, #b3261e);
  color: var(--biz-rail-badge-color, #ffffff);
  font-size: 11px;
  font-weight: 500;
  padding: 0 4px;
  border-radius: 8px;
  min-width: 16px;
  text-align: center;
  border: 2px solid var(--biz-rail-bg, #f3f4f9); /* Outline to match rail bg */
}
