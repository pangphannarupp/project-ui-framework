<template>
  <div class="pp-autocomplete-wrapper" ref="wrapperRef">
    <label v-if="label" class="pp-input-label">{{ label }}</label>
    <div 
      class="pp-input-container" 
      :class="{ 'pp-input-container--focused': isFocused }"
    >
      ...
      <div class="pp-input-actions">
        <button v-if="modelValue" type="button" class="pp-input-action-btn" @click="clearInput">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <line x1="18" y1="6" x2="6" y2="18"></line>
            <line x1="6" y1="6" x2="18" y2="18"></line>
          </svg>
        </button>
        <span class="pp-input-icon pp-input-icon--right">
    ...
    <Transition name="dropdown">
      <div v-if="isOpen" class="pp-autocomplete-dropdown">
        <ul v-if="filteredOptions.length > 0" class="pp-autocomplete-list">
          <li 
            v-for="(option, index) in filteredOptions" 
            :key="index"
            class="pp-autocomplete-item"
        ...
        <div v-else class="pp-autocomplete-empty">
          No results found.
        </div>
      </div>
    </Transition>
...
.pp-autocomplete-item.is-active {
