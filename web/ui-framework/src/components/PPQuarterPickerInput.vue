...
import PPQuarterPicker from './PPQuarterPicker.vue';

const props = withDefaults(defineProps<{
  modelValue?: { year: number, quarter: number } | null;
  placeholder?: string;
  clearable?: boolean;
  format?: (val: { year: number, quarter: number }) => string;
}>(), {
  modelValue: null,
...
const emit = defineEmits<{
  (e: 'update:modelValue', value: { year: number, quarter: number } | null): void;
}>();
...
const onQuarterSelected = (payload: { year: number, quarter: number }) => {
