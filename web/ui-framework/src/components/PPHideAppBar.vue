<template>
  <div class="pp-hide-appbar-wrapper">
    <!-- Header Layer -->
    <div 
      class="pp-hide-appbar-header"
      :style="{
    ...
    <div 
      class="pp-hide-appbar-content"
      @scroll="onScroll"
      ref="scrollArea"
    >
      <div class="pp-hide-appbar-spacer" :style="{ height: `${headerHeight}px` }"></div>
      <slot></slot>
    </div>
  </div>
</template>
