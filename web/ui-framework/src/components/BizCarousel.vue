<template>
  ...
  >
    ...
    <button 
      v-if="showArrows" 
      class="biz-carousel-arrow is-prev" 
      @click="prev"
    ...
    <button 
      v-if="showArrows" 
      class="biz-carousel-arrow is-next" 
      @click="next"
    ...
    <!-- Dots Pagination -->
    <div v-if="showDots && totalDots > 1" class="biz-carousel-dots">
      <button 
        v-for="index in totalDots" 
        :key="index"
        class="biz-carousel-dot"
...
.biz-carousel-arrow.is-prev {
  left: 16px;
}
.biz-carousel-arrow.is-next {
  right: 16px;
}
