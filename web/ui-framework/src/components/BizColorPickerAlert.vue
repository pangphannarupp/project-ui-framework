<template>
  <div v-if="modelValue" class="biz-color-alert-overlay" @click="onOverlayClick">
    <div class="biz-color-alert-content" @click.stop>
...
import BizColorPicker from './BizColorPicker.vue';
