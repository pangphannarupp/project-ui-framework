...
import PPKeypad from './PPKeypad.vue';
...
.currency-toggle {
  ...
  height: 26px;
  border-radius: 13px;
  background-color: var(--pp-primary-variant, #1a2a5e); /* USD default */
  position: relative;
  transition: all 0.3s;
  cursor: pointer;
}
...
:deep(.pp-keypad .keypad-btn.empty-btn) {
