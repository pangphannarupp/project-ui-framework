<template>
  <div class="biz-scroll-segment-wrapper" ref="wrapperRef">
    <div 
...
.biz-scroll-segment {
  ...
  align-items: center;
  overflow-x: auto;
  background-color: var(--biz-scroll-segment-bg, transparent);
  border-radius: var(--biz-scroll-segment-border-radius, 0);
  gap: var(--biz-scroll-segment-gap, 12px);
  padding: var(--biz-scroll-segment-padding, 8px 4px 12px 4px);
  scrollbar-width: none;
  -ms-overflow-style: none;
  margin-bottom: var(--biz-scroll-segment-margin-bottom, 16px);
  flex: 1;
}

.biz-scroll-segment::-webkit-scrollbar {
  display: none;
}
