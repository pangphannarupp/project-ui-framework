<template>
  <div class="pp-image-transition">
    ...
    >
      ...
      <div class="pp-image-detail" v-if="isExpanded || isAnimating" :style="detailStyle">
...
.pp-image-container.is-expanded :deep(img) {
  border-radius: 0;
}
