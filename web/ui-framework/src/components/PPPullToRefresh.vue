<template>
  <div 
    class="pp-ptr-wrapper"
    @touchstart="onTouchStart"
    @touchmove="onTouchMove"
    @touchend="onTouchEnd"
  >
    <div 
      class="pp-ptr-indicator"
      :style="{
        height: `${pullDistance}px`,
        transition: isRefreshing || isRestoring ? 'height 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)' : 'none'
      }"
    >
      <div class="pp-ptr-indicator-content" :style="{ opacity: pullProgress }">
        <div v-if="isRefreshing" class="pp-ptr-spinner">
