  ...
  <BizBottomSheet :modelValue="modelValue" @update:modelValue="$emit('update:modelValue', $event)">
    <div class="country-sheet-content">
      ...
      <div class="country-segment">
        <BizSegment v-model="activeTab">
          <BizSegmentButton value="popular">Popular</BizSegmentButton>
          <BizSegmentButton value="all">All Country</BizSegmentButton>
        </BizSegment>
      </div>
...
import BizInput from './BizInput.vue';
import BizSegment from './BizSegment.vue';
import BizSegmentButton from './BizSegmentButton.vue';
